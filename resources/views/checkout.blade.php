            ...
            <div class="col-lg-6">
                ...
                <div class="order-details">
                    ...
                    <div class="product-row d-flex justify-content-between">
                        ...
                        <div>
                            {{$currency}}{{App\Helpers\CurrencyHelper::getSetPriceFormat($productItem->price)}}
                        </div>
                    </div>
                    <div class="total d-flex justify-content-between">
                        <div>Total</div>
                        <div id="total" data-total="{{$productItem->price}}">{{$currency}}{{App\Helpers\CurrencyHelper::getSetPriceFormat($productItem->price)}}</div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="wrapper">
                                            ...
                                            <form action="{{route('braintree.payment')}}" id="payment-form-bt" method="POST">
                                                ...
                                                <input type="hidden" id="product_type" name="product_type" value="{{ $productItem->type }}"/>
...
@push("js")
    ...
    @if($braintreeEnabled)
        @include('js-for-views.payment-gateway-js.braintree-js', ['product' => $product])
    @endif
    @if($stripeEnabled)
